...
const channelData = [
  { id: 1, name: 'Channel 1', status: 'scheduler', content: 'Content 1', date: '2024-08-01', time: '10:00' },
  { id: 2, name: 'Channel 2', status: 'live', content: 'Content 2', date: '2024-08-01', time: '11:00' },
  { id: 3, name: 'Channel 3', status: 'idle', content: 'Content 3', date: '2024-08-01', time: '12:00' },
  { id: 4, name: 'Channel 4', status: 'unknown', content: 'Content 4', date: '2024-08-01', time: '13:00' },
  { id: 5, name: 'Channel 5', status: 'unknown', content: 'Content 4', date: '2024-08-01', time: '14:00' },
  { id: 6, name: 'Channel 6', status: 'unknown', content: 'Content 4', date: '2024-08-01', time: '15:00' },
  { id: 7, name: 'Channel 7', status: 'unknown', content: 'Content 4', date: '2024-08-01', time: '16:00' },
];
...
export default function LogChannel({ open, handleClose }) {
  ...
  return (
    ...
    >
      <DialogTitle sx={{ fontSize: "24px", fontWeight: "bold", color: "rgb(116, 165, 138)", display: 'flex', alignItems: 'center' }}>
        <SubscriptionsIcon sx={{ marginRight: '8px', fontSize: '32px' }} /> Log Channel
      </DialogTitle>
  ...
  {channelData.map((channel) => (
    <StyledTableRow key={channel.id}>
      ...
      <StatusTableCell status={channel.status}>{channel.status}</StatusTableCell>
