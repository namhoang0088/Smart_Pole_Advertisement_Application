...
//popup success---------------------end---------------------------
    ...
    return (
        ...
        >
            <DialogTitle sx={{ fontSize: "24px", fontWeight: "bold", color: "#70d8bd", display: 'flex', alignItems: 'center' }}>
                <AddBoxIcon sx={{ marginRight: '8px', fontSize: '32px' }} /> Thêm video
            </DialogTitle>
            <DialogContent dividers>
                <Box marginBottom="20px" marginTop="20px" display="flex" alignItems="center">
                    <OndemandVideoIcon sx={{ color: colors.greenAccent[600], fontSize: "36px" }} />
                    ...
                    <Button
                        variant="contained"
                        component="label"
                        sx={{ backgroundColor: colors.greenAccent[600], color: "#fff", marginLeft: "20px" }}
