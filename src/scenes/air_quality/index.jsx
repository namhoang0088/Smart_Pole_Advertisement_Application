  ...
  const  handleClickAirqualityhistory = () =>{
    ...
    >
      ...
      >
        ...
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}>Smart pole 1</Typography>

        <MyLocationIcon sx={{ color: colors.greenAccent[600], fontSize: "26px", marginLeft:"50px" }}/>
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}>10.880415:106.805633</Typography>

        <LocationOnIcon sx={{ color: colors.greenAccent[600], fontSize: "26px", marginLeft:"50px" }}/>
        <Typography variant="h6" sx={{ fontWeight: 'bold' }}>Dĩ an</Typography>
...
{/* //------------------------------------------------------------------------------------------------------*/}
          ...
          <Typography variant="h6" sx={{ marginRight:'10px'}}>Nhiệt độ</Typography>
          <Typography variant="h6" sx={{ marginRight:'10px', fontWeight: 'bold' }}>30℃ </Typography>
          </ListItem>
{/* //------------------------------------------------------------------------------------------------------*/}
  ...
  <Box sx={{ width: '70%', marginLeft: '31px' , marginRight:'10px'}}>
...
{/* //------------------------------------------------------------------------------------------------------*/}
          <ListItem>
          <AirIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }}/>
          <Typography variant="h6" >PM2.5</Typography>
          <Box sx={{ width: '70%', marginLeft: '34px' , marginRight:'10px'}}>
          <PM25Progress variant="determinate" value={getProgressPercentage(100)} />
          </Box>
          <Typography variant="h6" >100 µg/m³</Typography>
          </ListItem>
 {/* //------------------------------------------------------------------------------------------------------*/}         
          <ListItem>
          <GrainIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }}/>
          <Typography variant="h6" >PM10</Typography>
          <Box sx={{ width: '70%', marginLeft: '38px' , marginRight:'10px'}}>
          <PM25Progress variant="determinate" value={getProgressPercentage(150)} />
          </Box>
          <Typography variant="h6" >150 µg/m³</Typography>
          </ListItem>
{/* //------------------------------------------------------------------------------------------------------*/}
          <ListItem>
          <NoiseControlOffIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }}/>
          <Typography variant="h6" sx={{ marginRight:'10px'}}>Tiếng ồn</Typography>
          <Box sx={{ width: '70%', marginLeft: '10px' , marginRight:'10px'}}>
          <NoiseProgress variant="determinate" value={getProgressPercentageNoise(110)} />
          </Box>
          <Typography variant="h6" >110 db</Typography>
          </ListItem>
{/* //------------------------------------------------------------------------------------------------------*/}
          <ListItem>
          <LightModeIcon sx={{ color: colors.greenAccent[600], fontSize: "26px" }}/>
          <Typography variant="h6" sx={{ marginRight:'10px'}}>Cường độ ánh sáng</Typography>
          <Typography variant="h6" sx={{ marginRight:'10px', fontWeight: 'bold' }}>1000 lx</Typography>
          </ListItem>
{/* //------------------------------------------------------------------------------------------------------*/}
          <ListItem>
          <Button
    ...
    >
     ...
     <AirQualityHistory open ={airqualityhistory} handleClose = {handleCloserAirqualityhistory}/>
      </Box>)
