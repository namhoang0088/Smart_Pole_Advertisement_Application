...
import { Box, ListItemButton, ListItemIcon, Typography, Collapse, List, Button, Checkbox } from "@mui/material";
...
const LiveAd= () => {
    ...
    return (
        <Box m="20px">
            <Header
                title="Live Stream"
                subtitle="Welcome to Live Stream"
            />
            <Box display="grid" gridTemplateColumns="70% 30%" gap="20px" alignItems="start">
...
>
    <video id="liveVideo" autoPlay style={{ maxWidth: "100%", maxHeight: "100%", width: "auto", height: "auto", objectFit: "contain" }}></video>
</Box>
                ...
                >
                    <Box marginBottom="20px" flexDirection="column" alignItems="center">
                        <ListItemButton onClick={handleClickListPole}>
                            <ListItemIcon>
                                <img src="/assets/smart_pole.webp" alt="Day Icon" style={{ width: "36px", height: "36px", marginRight: "10px" }} />
                        ...
                        <Collapse in={openListPole} timeout="auto" unmountOnExit>
                            <List component="div" disablePadding>
                                <Box marginBottom="10px" padding="5px" display="flex" alignItems="center" backgroundColor="#ffffff" borderRadius="10px">
                                    <Typography variant="h6" marginRight="10px" paddingLeft="10px">
                    ...
                    <Box display="flex" alignItems="center" marginLeft="50px">
                        <Button variant="contained" sx={{ backgroundColor: isMicOn ? '#007FFF' : '#757575', color: "#fff", marginLeft: "20px", display: 'flex', alignItems: 'center', padding : "5px" }} onClick={handleMicToggle}>
                            {isMicOn ? <MicIcon fontSize="large" /> : <MicOffIcon fontSize="large" />}
                        </Button>

                        <Button variant="contained" sx={{ backgroundColor: isCameraOn ? '#007FFF' : '#757575', color: "#fff", marginLeft: "20px", display: 'flex', alignItems: 'center', padding : "5px" }} onClick={handleCameraToggle}>
                            {isCameraOn ? <VideocamIcon fontSize="large" /> : <VideocamOffIcon fontSize="large" />}
                        </Button>

                        <Button variant="contained" sx={{ backgroundColor: '#FF0000', color: "#fff", marginLeft: "20px", display: 'flex', alignItems: 'center', padding : "5px" }}>
    ...
    sx={{ 
        ...
        '&:hover': { // thêm hiệu ứng hover khi di chuột qua button
